  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans">
      ...
      <aside className="w-48 bg-[#1e293b] text-white flex flex-col justify-between shrink-0">
        <div>
          ...
          <nav className="mt-4 flex flex-col gap-2">
            ...
            {/* 1. FIXED: Changed /canteen/dashboard to /owner/dashboard to match App.jsx */}
            <div onClick={() => navigate('/owner/dashboard')} className={`mx-2 py-3 px-4 rounded-xl flex flex-col items-center justify-center cursor-pointer transition ${isActive('dashboard') ? 'bg-[#eab308] text-[#1e293b] shadow-lg' : 'text-gray-300 hover:text-white opacity-70'}`}>
            ...
            {/* 2. FIXED: Added onClick for Help (even if you haven't built the page yet) */}
            <div onClick={() => navigate('/owner/help')} className={`mx-2 py-3 px-4 rounded-xl flex flex-col items-center justify-center cursor-pointer transition ${isActive('help') ? 'bg-[#eab308] text-[#1e293b] shadow-lg' : 'text-gray-300 hover:text-white opacity-70'}`}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        {/* TOP HEADER */}
        <header className="h-16 bg-[#f4f7fb] border-b flex justify-between items-center px-4 shadow-sm z-50 relative shrink-0">
