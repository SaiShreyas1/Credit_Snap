      ...
      <aside className="w-48 bg-[#1e293b] text-white flex flex-col justify-between shrink-0">
        <div>
          ...
          <nav className="mt-4 flex flex-col gap-2">
            ...
            {/* Added onClick and isActive styling for Debts */}
            ...
            {/* Added onClick and isActive styling for History! */}
            <div onClick={() => navigate('/student/history')} className={`mx-2 py-3 px-4 rounded-xl flex flex-col items-center justify-center cursor-pointer transition ${isActive('history') ? 'bg-[#f97316] text-white shadow-lg' : 'text-gray-300 hover:text-white opacity-70'}`}>
