...
export default function StudentLayout() {
  ...
  const location = useLocation(); // This tells us what URL we are currently on!

  // Profile & Notifications state lives HERE now!
  ...
  // Helper to make the sidebar button orange if it's the active page
  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-4 w-56 bg-white rounded-xl shadow-xl border border-gray-100 z-50 overflow-hidden">
                  ...
                  <div className="flex flex-col">
                    <div className="px-4 py-3 hover:bg-gray-50 cursor-pointer flex items-center gap-3 text-sm text-gray-700 transition"><Settings className="w-4 h-4" /> Account Settings</div>
                    <div className="px-4 py-3 hover:bg-red-50 cursor-pointer flex items-center gap-3 text-sm text-red-600 font-medium transition border-t border-gray-100"><LogOut className="w-4 h-4" /> Logout</div>
                  </div>
                </div>
              )}
            </div>
        ...
        {/* ========================================================= */}
        {/* THIS IS WHERE YOUR PAGES LOAD! The "Picture" inside the frame */}
        {/* ========================================================= */}
        <Outlet />
